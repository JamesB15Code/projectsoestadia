...
const CrudProducts = () => {
  ...
  const URL_PRODUCTOS_SELECT = "https://mginnovaviones.website/proyectoApi/selectProduct.php";
  const urlCloudinary =
    "https://api.cloudinary.com/v1_1/dchgfutbv/image/upload";
  const URL_PRODUCTOS = "https://mginnovaviones.website/proyectoApi/apiProducto.php";
